...
export const portfolioData: PortfolioData = {
    ...
    experiences: [
        ...
        },
        {
            ...
            description: 'Actively contributing to various open-source projects, improving codebases, and collaborating with global developers.',
            responsibilities: [
                'Developing and maintaining open-source tools',
                'Reviewing pull requests and fixing complex issues',
                'Improving documentation and project architecture'
            ],
        ...
        },
        {
            ...
            position: 'Mentor',
            description: 'Providing guidance and mentorship to aspiring developers, helping them navigate technical challenges and career paths.',
            responsibilities: [
                'Conducting technical mentorship sessions',
                'Reviewing code and providing constructive feedback',
                'Sharing industry best practices and architectural patterns'
            ],
            skills: ['Mentorship', 'Leadership', 'Code Review', 'Technical Communication'],
