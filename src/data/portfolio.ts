...
export const portfolioData: PortfolioData = {
    ...
    experiences: [
        {
            id: 'prof-1',
            company: 'GirlScript, SSOC, Open Source Connect, Elite Coders, Hacktoberfest',
            position: 'Open Source Contributor',
            description: 'Actively contributed to multiple open-source repositories through feature development, bug fixing, and collaborative coding. Gained hands-on experience with real-world development workflows, team-based software engineering, and open-source best practices.',
            responsibilities: [
                'Submitted meaningful pull requests, fixed bugs, and improved documentation across various projects',
                'Collaborated with maintainers and developers on backend development, automation workflows, and performance optimization',
                'Recognized among the Top 50 performers in Elite Coders Winter of Code (ECWOC)'
            ],
            skills: ['Open-Source Software', 'Git', 'GitHub', 'Python', 'Backend Development'],
            ...
            externalLink: 'https://github.com/Aamod007',
        },
        {
            id: 'prof-2',
            company: 'GirlScript, SSOC, SWOC, Open Source Connect',
            ...
            responsibilities: [
                'Fostered technical growth, collaborative development practices, and inclusive participation within the open-source community',
                'Guided new contributors in open-source development, helping with project architecture and issue resolution',
                'Led open-source awareness and contributor onboarding programs as Campus Lead for Open Source Connect'
            ],
            skills: ['Mentorship', 'Leadership', 'AI/ML Workflows', 'System Design', 'Code Review'],
            startDate: '2026-01-01',
            endDate: 'Present',
            isOngoing: true,
            location: 'Remote',
            type: 'volunteer',
            logo: '/assets/mentor.png',
            externalLink: '#',
        },
        {
            id: 'prof-3',
