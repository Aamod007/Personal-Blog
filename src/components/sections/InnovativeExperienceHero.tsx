...
const NODES_DATA: Record<string, NodeData[]> = {
    education: [
        { label: 'Lovely Professional University', description: 'Bachelor of Technology - Computer Software Engineering (CGPA 7.3/10).', orbitIndex: 0, position: 0.1, imageUrl: "https://images.unsplash.com/photo-1562774053-701939374585?q=80&w=400&auto=format&fit=crop" },
        { label: 'Sacred Heart Higher Secondary School', description: 'Science, Mathematics and Computer Science.', orbitIndex: 1, position: 0.25, imageUrl: "https://images.unsplash.com/photo-1580582932707-520aed937b7b?q=80&w=400&auto=format&fit=crop" },
